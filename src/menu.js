...
function generateMenu() {
    ...
    const amt2 = document.createElement("h3");
    ...
    const amt3 = document.createElement("h3");
    ...
    collection.appendChild(dish1);
    collection.appendChild(dish2);
    collection.appendChild(dish3);
